...
if($url){
	...
	if(count($products) > 0){
		...
		//	if($title1=='/^American/')
			...
			//Only image, price, url and title1 are used in this demo
			...
			echo '<a target="_blank" href="'.$productUrl.'"><img src="'.$productImage.'"/><br>'.$title1."</a><br>Rs. ".$sellingPrice;
